...
public:
	...
	LocoMouse_Feature& operator=(const LocoMouse_Feature& other); //copy assign
	LocoMouse_Feature& operator=(LocoMouse_Feature&& other); //move assign
...
public:
	...
	LocoMouse_Model& operator=(LocoMouse_Model &&other); //move assign
...
//NOTE: Apparently Visual Studio is able to handle template stuff outside of the header file but gcc won't.
template <typename T>
